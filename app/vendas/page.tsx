...
function Card3D({ children, style }: { children: React.ReactNode; style?: React.CSSProperties }) {
  ...
  return (
    <div onMouseMove={e => { const r = e.currentTarget.getBoundingClientRect(); setRotate({ x: (e.clientY - r.top - r.height / 2) / r.height * -8, y: (e.clientX - r.left - r.width / 2) / r.width * 8 }); }} onMouseEnter={() => setHover(true)} onMouseLeave={() => { setHover(false); setRotate({ x: 0, y: 0 }); }}
...
export default function Vendas() {
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", fontFamily: "sans-serif", color: C.text, overflowX: "hidden" }}>
      ...
      {/* Nav */}
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", background: scrollY > 50 ? C.bg + "ee" : "transparent", backdropFilter: scrollY > 50 ? "blur(20px)" : "none", borderBottom: scrollY > 50 ? `1px solid ${C.border}` : "1px solid transparent", transition: "all 0.3s" }}>
        ...
        <div style={{ display: "flex", gap: 28, alignItems: "center" }}>
          {[["funcionalidades", "Funcionalidades"], ["integracoes", "Integrações"], ["planos", "Planos"], ["faq", "FAQ"]].map(([id, label]) => (
      ...
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "120px 32px 80px", position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", maxWidth: 780 }}>
          ...
          <div style={{ opacity: 0, animation: "fadeUp 0.8s ease 0.4s forwards" }}>
            <h1 style={{ fontSize: "clamp(42px, 7vw, 72px)", fontWeight: 900, color: C.white, margin: "0 0 24px", lineHeight: 1.0, letterSpacing: "-0.05em" }}>
          ...
          <div style={{ opacity: 0, animation: "fadeUp 0.8s ease 0.6s forwards" }}>
            <p style={{ fontSize: 20, color: C.muted, lineHeight: 1.7, margin: "0 0 48px", maxWidth: 560, marginLeft: "auto", marginRight: "auto" }}>
          ...
          <div style={{ opacity: 0, animation: "fadeUp 0.8s ease 0.8s forwards", display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="/login" style={{ background: "linear-gradient(135deg, #7C3AED, #A855F7)", color: C.white, borderRadius: 16, padding: "18px 40px", fontSize: 17, fontWeight: 800, textDecoration: "none", boxShadow: "0 8px 40px #7C3AED66" }}>
              Criar conta grátis →
            </a>
            <button onClick={() => document.getElementById("planos")?.scrollIntoView({ behavior: "smooth" })} style={{ background: "transparent", color: C.text, border: `1px solid ${C.border}`, borderRadius: 16, padding: "18px 32px", fontSize: 16, fontWeight: 600, cursor: "pointer", fontFamily: "sans-serif" }}>
              Ver planos
            </button>
          </div>
          ...
          <div style={{ opacity: 0, animation: "fadeUp 0.8s ease 1s forwards", marginTop: 80, display: "flex", justifyContent: "center", gap: 60, flexWrap: "wrap" }}>
            {[["4.800+", "respostas coletadas"], ["320+", "formulários criados"], ["100%", "produto brasileiro"]].map(([n, l]) => (
              <div key={l} style={{ textAlign: "center" }}>
                <div style={{ fontSize: 30, fontWeight: 900, color: C.white, letterSpacing: "-0.04em" }}>{n}</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16, marginBottom: 40 }}>
            {[
              ...
              <Reveal key={f.title} delay={i * 150}>
                <Card3D style={{ background: `linear-gradient(135deg, ${f.color}11, ${C.bgCard})`, border: `1px solid ${f.color}33`, borderRadius: 24, padding: 28, position: "relative", overflow: "hidden", height: "100%" }}>
          ...
          <Reveal delay={200}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 12 }}>
              {[
                ...
                <div key={f.title} style={{ background: C.bgCard, border: `1px solid ${C.border}`, borderRadius: 14, padding: "16px 14px", textAlign: "center", transition: "border-color 0.2s, transform 0.2s" }}
      ...
      {/* Integrações */}
      <section id="integracoes" style={{ padding: "80px 32px", position: "relative", zIndex: 1, background: `linear-gradient(180deg, transparent, ${C.bgCard}88, transparent)` }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              ...
              <h2 style={{ fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 900, color: C.white, margin: "0 0 16px", letterSpacing: "-0.04em" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 14, marginBottom: 40 }}>
            {integrations.map((int, i) => (
              <Reveal key={int.name} delay={i * 60}>
                <Card3D style={{ background: C.bgCard, border: `1px solid ${C.border}`, borderRadius: 16, padding: "20px 14px", textAlign: "center", cursor: "pointer" }}>
                  <div style={{ display: "flex", justifyContent: "center", marginBottom: 10 }}>{int.icon}</div>
                  <div style={{ fontSize: 13, fontWeight: 700, color: C.text }}>{int.name}</div>
                </Card3D>
              </Reveal>
            ))}
          </div>
      ...
      <section style={{ padding: "80px 32px", position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <h2 style={{ fontSize: "clamp(26px, 4vw, 38px)", fontWeight: 900, color: C.white, textAlign: "center", margin: "0 0 48px", letterSpacing: "-0.04em" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 }}>
            {[
              ...
              <Reveal key={t.name} delay={i * 150}>
                <Card3D style={{ background: `linear-gradient(160deg, ${C.bgCard2}, ${C.bgCard})`, border: `1px solid ${C.border}`, borderRadius: 20, padding: 24, height: "100%", boxSizing: "border-box" as React.CSSProperties["boxSizing"] }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <div style={{ width: 38, height: 38, borderRadius: "50%", background: "linear-gradient(135deg, #7C3AED, #A855F7)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 700, color: C.white }}>{t.avatar}</div>
                    <div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 48 }}>
              ...
              <h2 style={{ fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 900, color: C.white, margin: "0 0 12px", letterSpacing: "-0.04em" }}>
      ...
      <section id="faq" style={{ padding: "80px 32px", position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <Reveal>
            <h2 style={{ fontSize: "clamp(26px, 4vw, 38px)", fontWeight: 900, color: C.white, textAlign: "center", margin: "0 0 48px", letterSpacing: "-0.04em" }}>Perguntas frequentes</h2>
          </Reveal>
      ...
      <section style={{ padding: "100px 32px", textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        <Reveal>
          <div style={{ position: "relative", maxWidth: 600, margin: "0 auto" }}>
            <h2 style={{ fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 900, color: C.white, margin: "0 0 20px", letterSpacing: "-0.04em", lineHeight: 1.1 }}>
            ...
            <a href="/login" style={{ background: "linear-gradient(135deg, #7C3AED, #A855F7, #E879F9)", color: C.white, borderRadius: 18, padding: "20px 48px", fontSize: 18, fontWeight: 900, textDecoration: "none", boxShadow: "0 12px 48px #7C3AED66", display: "inline-block" }}>
      ...
      {/* Footer */}
      <footer style={{ borderTop: `1px solid ${C.border}`, padding: "28px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16, position: "relative", zIndex: 1 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ fontSize: 13, color: C.muted }}>© 2025 BravaForm · Produto brasileiro · Nota fiscal inclusa</div>
